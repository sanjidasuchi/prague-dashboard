...
with col_right:
    if mode == "💬 Comments":
        ...
        st.markdown(
            ...
            '<td style="font-size:11px;padding:2px 4px;text-align:center;color:#222;background:#fff">Low</td>'
            '<td style="font-size:11px;padding:2px 4px;text-align:center;color:#222;background:#fff">Mid</td>'
            '<td style="font-size:11px;padding:2px 4px;text-align:center;color:#222;background:#fff">High</td>'
            '</tr><tr>'
            '<td style="font-size:11px;padding:2px 4px;font-weight:600;color:#222;background:#fff">High</td>'
            '<td style="background:#be64ac;width:30px;height:26px"></td>'
            '<td style="background:#8c62aa;width:30px;height:26px"></td>'
            '<td style="background:#3b4994;width:30px;height:26px"></td>'
            '</tr><tr>'
            '<td style="font-size:11px;padding:2px 4px;font-weight:600;color:#222;background:#fff">Mid</td>'
            '<td style="background:#dfb0d6;width:30px;height:26px"></td>'
            '<td style="background:#a5b4c2;width:30px;height:26px"></td>'
            '<td style="background:#5698b9;width:30px;height:26px"></td>'
            '</tr><tr>'
            '<td style="font-size:11px;padding:2px 4px;font-weight:600;color:#222;background:#fff">Low</td>'
            '<td style="background:#e8e8e8;width:30px;height:26px"></td>'
            '<td style="background:#ace4e4;width:30px;height:26px"></td>'
            '<td style="background:#5ac8c8;width:30px;height:26px"></td>'
            '</tr><tr>'
            '<td></td>'
            f'<td colspan="3" style="font-size:11px;font-weight:600;text-align:center;color:#222;'
