...
with col_right:
    if mode == "💬 Comments":
        ...
        st.markdown(
            ...
            '<tr>'
            '<td style="font-size:11px;padding:2px 4px;font-weight:600;color:#222"></td>'
            '<td style="font-size:11px;padding:2px 4px;text-align:center;color:#222">Low</td>'
            '<td style="font-size:11px;padding:2px 4px;text-align:center;color:#222">Mid</td>'
            '<td style="font-size:11px;padding:2px 4px;text-align:center;color:#222">High</td>'
            '</tr><tr>'
            '<td style="font-size:11px;padding:2px 4px;font-weight:600;color:#222">High</td>'
            ...
            '</tr><tr>'
            '<td style="font-size:11px;padding:2px 4px;font-weight:600;color:#222">Mid</td>'
            ...
            '</tr><tr>'
            '<td style="font-size:11px;padding:2px 4px;font-weight:600;color:#222">Low</td>'
